...
{ 
    ...
    { 
        ...
        lblTempo = new Label();
        lblTempo.Text = "Tempo: 15s";
        lblTempo.Font = new System.Drawing.Font("Arial", 14, System.Drawing.FontStyle.Bold);
        lblTempo.Location = new System.Drawing.Point(20, 60);
        lblTempo.Size = new System.Drawing.Size(150, 30);
        lblTempo.ForeColor = System.Drawing.Color.Green;
        this.Controls.Add(lblTempo);

        timerPergunta = new System.Windows.Forms.Timer();
        timerPergunta.Interval = 1000;
        timerPergunta.Enabled = false;
        timerPergunta.Tick += new EventHandler(timerPergunta_Tick);
